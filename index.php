    ...
    <main>
        ...
        <div id="paraCont">
            <div id="contContainer">
                <h1> Who are we!</h1>
                <p> Doctors reminder is a platform for the students of PNU، the goal is to bridge the gap between
                    professors and students by creating an easy-to-use platform that simplifies scheduling, and ensures
                    students stay informed — all in real time.</p>
            </div>
